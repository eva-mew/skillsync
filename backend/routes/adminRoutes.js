...
const {
  ...
  getMonthlyApplications, getApplicationsByDate, getJobApplicants, postJob, toggleJobStatus,  getRevenueReport, getPremiumUsers, getCVApplications
...
router.get('/cv-applications', protect, adminOnly, getCVApplications);
